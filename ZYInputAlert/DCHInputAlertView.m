...
@implementation DCHInputAlertView
...
- (void)show
{
    ...
    // 输入框
    self.frame = CGRectMake(0, 0, becloudView.frame.size.width * 0.8, becloudView.frame.size.height * 0.2);
...
#pragma mark - 移除DCHInputAlertView
- (void)dismiss
{
